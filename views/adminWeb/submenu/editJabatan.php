						...
						<div class="tCheader">
							<div class="tchbox">
								<div class="dropdownCat">
				                    <button class="dropbtn" id="EJBtn" title="klik untuk memilih kategori"><span id="EJbtnLabel" style="pointer-events: none;">Pilih Biro</span> <span class="glyphicon glyphicon-triangle-bottom" style="pointer-events: none;"></span></button>
				                    <div class="dropdownCat-content" id="EJContent">
				                        <?php
				                            $i=0;
				                            while ($b = mysqli_fetch_array($BiroQuery)) {
				                                if($b[$i]==null){
				                                    echo "";
				                                } else {
				                        ?>
				                        <a onclick="selectBiro('<?php echo $b['nama_jabatan'] ?>')" href="#"><?php echo $b['nama_jabatan']; ?></a>
				                        <?php
				                                }
				                            }
				                        ?>
				                ...
				                <div class="SAwrapper">
									...
									<div class="searchPegawai h30">
					                    <input type="text" id="jabSearch" class="h30" onkeyup="searchJab()" title="Mencari jenis jabatan" placeholder="Search Nama Jabatan" style="width: 100%; padding-left: 10px;">
					                </div>
						            Result: 
