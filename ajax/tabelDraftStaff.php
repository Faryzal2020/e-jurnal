...
if(mysqli_num_rows($result) > 0){
    ...
    while($data = mysqli_fetch_array($result))
    {
        ...
        if($data[13] == '1'){
            ...
            echo "<td class='validasiNO'><span>NO</span><button class='pencetan' style='display: block; padding: 5px; margin: 3px;' onclick=\"bukaModalValidasi('lihat','$data[13]')\">Lihat Pesan</button></td>";
        }
