						...
						<div class="tCheader">
							<div class="tchbox">
								<div class="dropdownCat">
				                    <button class="dropbtn" id="ddcBtn" title="klik untuk memilih kategori :&#013;+kehadiran berisi kegiatan diluar kantor"><span id="ddcbtnLabel" style="pointer-events: none;">Pilih Kategori</span> <span class="glyphicon glyphicon-triangle-bottom" style="pointer-events: none;"></span></button>
								...
								<div class="SAwrapper">
									<div class="searchActivity">
					                    ...
					                    <input type="text" id="actSearch" onkeyup="searchAct()" placeholder="Search Aktivitas" title="mencari aktivitas yang ingin anda input">
					                </div>
						            Result: 
			                        ...
			                        <form name="FormSJ" id="FormSJ" method="post" action="">
			                            <table border="0" cellpadding="8" cellspacing="0" width="650" align="center" class="tableSJ" id="tableSJ">
			                                ...
			                                <tr>
			                                	...
			                                	<td>:</td>
			                                    <td colspan="3"><input type="text" name="tglJurnal" id="tglJurnal" value="<?php echo date("Y-m-d"); ?>"  title="masukkan tanggal mulai aktivitas pada jurnal anda"></td>
			                                </tr>
			                                <tr>
			                                    <td><label id="labelWaktuMulai">Waktu Mulai</label></td>
			                                    <td>:</td>
			                                    <td id="tanggal"><input type="text" name="tglMulai" id="tglMulai" value="<?php echo date("Y-m-d"); ?>" title="masukkan tanggal mulai aktivitas pada jurnal anda"></td>
			                                ...
			                                <tr>
			                                    ...
			                                    <td>:</td>
			                                    <td><input type="text" name="tglSelesai" id="tglSelesai" value="<?php echo date("Y-m-d"); ?>" title="masukkan tanggal selesai aktivitas pada jurnal anda"></td>
			                                    <td>
			                                    	<div class="input-group clockpicker">
			                                ...
			                                <tr>
			                                    <td colspan="5" align="right" style="height: 40px; padding: 10px; padding-top: 20px"><a name="tcmSubmit" class="SJbtnSubmit" onclick="validateSJ()" title="klik untuk menyimpan jurnal anda">Simpan</a></td>
			                                </tr>
			                            </table>
			                        </form>
			                    </div>
