						...
						<div class="tCheader">
							<div class="tchbox">
								<div class="dropdownCat">
				                    <button class="dropbtn" id="ddcBtn"><span id="iconDDC1" class="glyphicon glyphicon-chevron-down"></span><span id="iconDDC2" class="glyphicon glyphicon-chevron-right" style="display:none;"></span> <span id="ddcbtnLabel" style="pointer-events: none;">Pilih Kategori</button>
